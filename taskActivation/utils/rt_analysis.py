...
Shared by:
  - taskActivation.py       (live RT-Cloud analysis, DICOM streaming)
  - test_mock_scanner.py    (offline mock-DICOM-scanner test)
  - tutorial/test_pipeline.py, tutorial/test_generalize.py
                             (offline harnesses that validate the pipeline on
                             real ds000244 HcpMotor/HcpGambling designs
                             without rtCommon or a scanner)
